  ...
  return (
    <div className={StyleForm.pageContainer}>
      <div className={StyleForm.container}>
        <div
          className={`${StyleForm.imageSection} ${
            isRegistering ? StyleForm.register : StyleForm.login
          }`}
        >
          <img
            className={`${StyleForm.im} ${
              !isRegistering ? StyleForm.scaledImage : ""
            }`}
            ...
            {({ errors, touched }) => (
              <Form className={StyleForm.for}>
                ...
                <button
                  ...
                  className={
                    disabledBtn
                      ? `${StyleForm.submitButton} ${StyleForm.disableBtn}`
